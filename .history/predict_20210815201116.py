...
if __name__ == "__main__":
    ...
    cmd=f'ffmpeg -i {"E:\\user\\python\\my_yolov4\\yolov4-pytorch-master\\video\\wzry_output.mp4"} -i {music_path} -codec copy E:\\user\\python\\my_yolov4\\yolov4-pytorch-master\\video\\out_music.mp4'
